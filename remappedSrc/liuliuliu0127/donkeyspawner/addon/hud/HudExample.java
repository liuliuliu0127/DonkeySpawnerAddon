package liuliuliu0127.donkeyspawner.addon.hud;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(DonkeySpawnerAddon.HUD_GROUP, "example", "HUD element example.", HudExample::new);
